const UPGS = {
    mass: {
        ...
        2: {
            ...
            effDesc(eff) {
                return {
                    ...
                    eff: "x"+format(eff.eff)+" to Muscler effect"
                }
            },
            bonus() {
                let x = E(0)
        ...
        3: {
            ...
            effDesc(eff) {
                return {
                    ...
                    eff: "^"+format(eff.eff)+" to Booster effect"+(eff.eff.gte(eff.ss)?` <span class='soft'>(softcapped${(eff.eff.gte(1.8e5)&&(!hasElement(292)))?eff.eff.gte(5e15)&&!player.ranks.pent.gte(15)?"^3":"^2":""})</span>`:"")
                }
            },
            bonus() {
                let x = E(0)
        ...
        4: {
            ...
            effDesc(eff) {
                return {
                    step: "+^"+format(eff.step),
                    eff: "^"+format(eff.eff)+" to Stronger effect"+(eff.eff.gte(eff.ss)?` <span class='soft'>(softcapped${eff.eff.gte(eff.ss2)?"^2":""})</span>`:"")
                }
            },
            bonus() {
                let x = E(0)
    ...
    prestigeMass: {
        ...
        2: {
            ...
            effDesc(eff) {
                return {
                    step: "+"+format(eff.step)+"x",
                    eff: "x"+format(eff.eff)+" to Prestige Muscler effect"
                }
            },
        },
        3: {
            ...
            effDesc(eff) {
                return {
                    step: "+^"+format(eff.step),
                    eff: "^"+format(eff.eff)+" to Prestige Booster effect"+(eff.eff.gte(eff.ss)?` <span class='soft'>(softcapped)</span>`:"")
                }
            },
        },
        4: {
            ...
            effDesc(eff) {
                return {
                    step: "+"+format(eff.step)+"x",
                    eff: "x"+format(eff.eff)+" to Prestige Stronger effect"
                }
            }
        },
    },
    ascensionMass: {
        ...
        2: {
            ...
            effDesc(eff) {
                return {
                    step: "+"+format(eff.step)+"x",
                    eff: "x"+format(eff.eff)+" to Ascension Muscler effect"
                }
            },
        },
        3: {
            ...
            effDesc(eff) {
                return {
                    step: "+^"+format(eff.step),
                    eff: "^"+format(eff.eff)+" to Ascension Booster effect"+(eff.eff.gte(eff.ss)?` <span class='soft'>(softcapped)</span>`:"")
                }
            },
        },
        4: {
            ...
            effDesc(eff) {
                return {
                    step: "+"+format(eff.step)+"x",
                    eff: "x"+format(eff.eff)+" to Ascension Stronger effect"
                }
            }
        },
    },
    main: {
        ...
        1: {
            ...
            3: {
                desc: "Unlock autobyers for mass upgrades.",
                cost: E(25),
            },
            4: {
                desc: "Ranks reset nothing.",
                cost: E(50),
            },
            5: {
            ...
            7: {
                desc: "Every 3 Tickspeeds add one Stronger.",
                cost: E(1e7),
                effect() {
            ...
            8: {
                desc: "Super & Hyper Mass Upgrades scaling is weakened by Rage Points.",
                cost: E(1e15),
                effect() {
            ...
            9: {
                ...
                desc: "Stronger effect increases by +^0.25.",
                cost: E(1e31),
            },
            10: {
                unl() { return player.bh.unl || player.chal.unl},
                desc: "Super Rank scaling becomes 20% weaker.",
                cost: E(1e43),
            },
            11: {
                unl() { return player.chal.unl },
                desc: "Rage Points boost Black Hole Mass gain.",
                cost: E(1e72),
                effect() {
            ...
            12: {
                unl() { return player.chal.unl },
                desc: "Increase Stronger effect based on OoM of Rage Powers.",
                cost: E(1e120),
                effect() {
            ...
            17: {
                unl() { return hasUpgrade('inf',15) },
                desc: "First Stronger softcap is weaker.",
                cost: E('e2e101'),
            },
            18: {
                unl() { return hasUpgrade('inf',15) },
                desc() {return "Rage Power boosts Infinity Mass."},
                cost: E('e1e113'),
                effect() {
            ...
            20: {
                ...
                desc() {return "Rage Power boosts Accelerator Power."},
                cost: E('ee151'),
                effect() {
            ...
            22: {
                unl() { return hasUpgrade('exotic',19) },
                desc: "Rage Power boosts Tickspeed Power.",
                cost: E('ee1.25e14'),
                effect() {
            ...
            23: {
                unl() { return hasUpgrade('exotic',19) },
                desc: "Softcap of Rage Upgrade 12 is weaker.",
                cost: E('ee1.5e14'),
            },
            24: {
                unl() { return hasUpgrade('exotic',19) },
                desc: "Rage Upgrade 18 boosts Galactic Quarks.",
        ...
        2: {
            ...
            3: {
                desc: "Super Mass Upgrade scaling starts later based on Black Hole Mass.",
                cost: E(100),
                effect() {
            ...
            9: {
                unl() { return player.chal.unl },
                desc: "Stronger's effect softcap starts later based on unspent Dark Matters.",
                cost: E(1e27),
                effect() {
            ...
            12: {
                unl() { return player.atom.unl },
                desc: "Hyper Tickspeed scaling is reduced by 15%.",
                cost: E(1e120),
            },
            13: {
                unl() { return player.atom.unl },
            ...
            16: {
                unl() { return hasUpgrade('inf',15) },
                desc: "Black Hole Overflow starts ^10 later.",
                cost: E('ee100'),
            },
            17: {
                unl() { return hasUpgrade('inf',15) },
                desc: "Remove Black Hole Mass formula softcap. Black Hole Mass gain softcap is 10% weaker.",
                cost: E('e3e102'),
            },
            18: {
                unl() { return hasUpgrade('inf',15) },
                desc() {return "Dark Matter boosts Infinity Mass."},
                cost: E('e1e116'),
                effect() {
            ...
            19: {
                unl() { return hasUpgrade('inf',15) },
                desc: "Black Hole effect exponentially boosts mass gain.",
                cost: E('e2e130'),
                effect() {
            ...
            21: {
                unl() { return hasUpgrade('exotic',19) },
                desc: "Dark Matter boosts BH Condenser Power.",
                cost: E('ee1.22e14'),
                effect() {
            ...
            22: {
                unl() { return hasUpgrade('exotic',19) },
                desc: "Dark Matter Upgrade 18 boosts Galactic Quarks.",
                cost: E('ee1.5e14'),
            },
            23: {
                unl() { return hasUpgrade('exotic',19) },
            ...
            25: {
                unl() { return hasUpgrade('exotic',19) },
                desc: "Mass of Black Hole boosts Exotic Matter gain.",
                cost: E('ee4.7e14'),
                effect() {
        ...
        3: {
            ...
            lens: 25,
            1: {
                desc: "Start with all Mass upgrades available for purchase.",
                cost: E(1),
            },
            2: {
            ...
            4: {
                desc: "Keep Challenges 1-4 on Atom reset. BH Condensers increase Cosmic Rays Power at a reduced rate.",
                cost: E(1e10),
                effect() {
            ...
            6: {
                desc: "Gain 100% of Dark Matters gained from reset per second. Black Hole Mass softcap starts later based on Atomic Powers.",
                cost: E(1e18),
                effect() {
            ...
            10: {
                desc: "Tier requirement is halved. Hyper Rank starts later based on Tier.",
                cost: E(5e47),
                effect() {
            ...
            13: {
                ...
                desc() {if(player.prestiges[0].gte(50))return "All Cosmic Ray effect softcaps start x12 later."; return "Cosmic Ray effect's final softcap starts x10 later.";},
                cost: E('e3.2e11'),
            },
            14: {
                unl() { return player.md.break.active && (player.qu.rip.active || player.prestiges[0].gte(50)) },
            ...
            21: {
                unl() { return hasUpgrade('exotic',19) },
                desc: "Improve Quark gain formula, and raise Electron Power's 2nd effect by 4.",
                cost: E('ee1.92e11'),
            },
            22: {
                unl() { return hasUpgrade('exotic',19) },
                desc: "Boost all Star Generators gain.",
                cost: E('ee2.1e11'),
            },
            23: {
                unl() { return hasUpgrade('exotic',19) },
                desc: "Atom Upgrade 18 boosts Galactic Quarks.",
                cost: E('ee3e11'),
            },
            24: {
                unl() { return hasUpgrade('exotic',19) },
                desc: "Eliminate Atomic Overflow.",
                cost: E('ee4.2e11'),
            },
            25: {
                unl() { return hasUpgrade('exotic',19) },
        ...
        4: {
            ...
            11: {
                unl() { return player.md.break.active },
                desc: `Prestige Level resets nothing.`,
                cost: E(1e10),
            },
            12: {
                unl() { return player.md.break.active },
            ...
            18: {
                unl() { return hasUpgrade('inf',15) },
                desc: "Timeshard Effect is slightly stronger again (x2).",
                cost: E(1e266),
            },
            19: {
                unl() { return hasUpgrade('inf',15) },
                desc: "Timeshard Effect is slightly stronger again (x3?).",
                cost: E("1e337"),
            },
            20: {
                unl() { return hasUpgrade('inf',15) },
            ...
            24: {
                unl() { return hasUpgrade('exotic',19) },
                desc: "Impossible scaling of All Challenges is 20% weaker.",
                cost: E('e6e14'),
            },
            25: {
                unl() { return hasUpgrade('exotic',19) },
